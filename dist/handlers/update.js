...
exports.deleteUpdate = exports.updateUpdate = exports.createUpdate = exports.getUpdate = exports.getOneUpdate = void 0;
...
var getUpdate = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                updates = products.reduce(function (allUpdates, products) {
                    return __spreadArray(__spreadArray([], allUpdates, true), products.updates, true);
                }, []);
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!product) {
                    ...
                    return [2 /*return*/, res.json({ message: 'nope error error' })];
                }
